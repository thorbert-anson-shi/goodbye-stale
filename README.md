...
> Klik link berikut untuk pergi ke ke [deployment PWS]("http://thorbert-anson-goodbyestale.pbp.cs.ui.ac.id") dan [repository GitHub](https://github.com/thorbert-anson-shi/goodbye-stale) untuk <code>goodbye-stale</code>.
